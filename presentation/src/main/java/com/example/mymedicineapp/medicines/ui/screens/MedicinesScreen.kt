...
fun MedicinesScreen(navController: NavController, userName: String) {
    ...
    var medicineDomainModelClicked = remember { mutableStateOf(MedicineDomainModel("","",""))}
...
private fun greetingBasedOnTime():String {
    ...
    return when {
        currentTime in 6..11 -> stringResource(R.string.good_morning)
        currentTime in 12..16 -> stringResource(R.string.good_afternoon)
        currentTime in 17..20 -> stringResource(R.string.good_evening)
